...
import net.brigs.jLib.adapter.ICategoryItem;
import net.brigs.jLib.adapter.SimpleCategoriesAdapter;
import net.brigs.jLib.model.MockedItemsFactory;
import net.brigs.jLib.widget.LoopBarView;
import net.brigs.jLib.widget.OnItemClickListener;
import net.brigs.jLib.widget.Orientation;

import net.brigs.crm.modules.j_nav_lib.AbstractPageChangedListener;
import net.brigs.crm.modules.j_nav_lib.ColorFragment;
import net.brigs.crm.modules.j_nav_lib.SimpleFragmentStatePagerAdapter;
